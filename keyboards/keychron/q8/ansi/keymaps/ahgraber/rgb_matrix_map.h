...
// Index_KeyID
// 00_GRV,  01_1,    02_2,    03_3,  04_4,   05_5,   06_6,    07_7,   08_8,   08_9,   10_0,    11_MINS,  12_EQL,   13_BSPC,            14_DEL,
// 15_TAB,  16_Q,    17_W,    18_E,  19_R,   20_T,   21_Y,    22_U,   23_I,   24_O,   25_P,    26_LBRC,  27_RBRC,  28_BSLS,            29_PGUP,
// 30_CAPS, 31_A,    32_S,    33_D,  34_F,   35_G,            36_H,   37_J,   38_K,   39_L,    40_SCLN,  41_QUOT,  42_ENT,             43_PGDN,
...
// 58_LCTL, 59_LOPT, 60_LCMD,        61_SPC,         62_LFN,  63_RFN,         64_SPC,          65_RCMD,            66_LEFT,  67_DOWN,  68_RGHT
    ...
    const uint8_t LED_LIST_MACROCOL[] = {LED_DEL, LED_PGUP, LED_PGDN};
